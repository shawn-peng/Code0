...
struct Code0AppClass
{
	GtkApplicationClass parent_class;
};

G_DEFINE_TYPE(Code0App, example_app, GTK_TYPE_APPLICATION);

static void example_app_init(Code0App *app)
{
}
...
static void
example_app_class_init (Code0AppClass *class)
{
...
example_app_new(void)
{
	return g_object_new(EXAMPLE_APP_TYPE, "application-id",
			"org.gtk.exampleapp", "flags", G_APPLICATION_HANDLES_OPEN, NULL);
}
